...
#410K 005
A    = numpy.array([  -4.45059469049817, -4.61385080408746, 2.71494271504746])
B    = numpy.array([  3.03090782247952, -9.03798968520812, -1.60083760155620])
C    = numpy.array([  4.90542941173755, -1.98304713197018, 4.90832098790272 ])
PRE  = numpy.array([ 4.36513371,  4.65257411, -2.67157536])

#400K V003
A    = numpy.array([6.88819514071183, 0.281400088674475, 0.700643282308020])
B    = numpy.array([3.02741944879478, 7.82686800458408, 7.17070006047930])
C    = numpy.array([ -3.69976766648057, -8.83453527086136, 2.81887386239431])
#C -= B
PRE  = numpy.zeros(3)

#380K V000
A    = numpy.array([-5.09416847316490, 3.06322317571250, 4.07125633583284 ])
B    = numpy.array([-7.85427407347197, 1.82738257745078, -5.29152419263936 ])
C    = numpy.array([0.981948962609057, 4.64847868258844, -8.46672004352856 ])
